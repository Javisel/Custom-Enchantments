...
public class Enchant {
    ...
    public static boolean hasEnchantmentOnAnyEquipment(String enchantment, Player player) {

        for (int i=0; i <player.getEquipment().getArmorContents().length;i++) {



            if (Enchant.hasEnchant(enchantment, player.getEquipment().getArmorContents()[i])){
